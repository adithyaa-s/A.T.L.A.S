...
def edit_event(
    ...
    Args:
        ...
        summary (str, optional): New title/summary for the event. Pass an empty string or omit
            to keep the existing summary unchanged. Defaults to "".
        start_time (str, optional): New start time (e.g., "2023-12-31 14:00"). Pass an empty
            string or omit to keep unchanged. Defaults to "".
        end_time (str, optional): New end time (e.g., "2023-12-31 15:00"). Pass an empty
            string or omit to keep unchanged. Defaults to "".
